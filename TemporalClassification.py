...
def DenseModel():
    ...
    plt.title("Training Loss and Accuracy (Dense)")
    plt.xlabel("Epoch #")
    plt.ylabel("Loss/Accuracy")
    plt.legend()
    plt.savefig('./output/Dense2.0.png')
...
def RNN():
    ...
    H = model.fit(x_train_padded_seqs, y_train,
                         batch_size=32,
                         epochs=EPOCHS,
    ...
    plt.plot(N, H.history["accuracy"], label="train_acc")
    plt.plot(N, H.history["val_accuracy"], label="val_acc")
    plt.title("Training Loss and Accuracy (RNN)")
    plt.xlabel("Epoch #")
    plt.ylabel("Loss/Accuracy")
    plt.legend()
    plt.savefig('./output/RNN2.0.png')
...
def TextCNN():
    ...
    plt.plot(N, H.history["accuracy"], label="train_acc")
    plt.plot(N, H.history["val_accuracy"], label="val_acc")
    plt.title("Training Loss and Accuracy (TextCNN)")
    plt.xlabel("Epoch #")
    plt.ylabel("Loss/Accuracy")
    plt.legend()
    plt.savefig('./output/TextCNN2.0.png')
